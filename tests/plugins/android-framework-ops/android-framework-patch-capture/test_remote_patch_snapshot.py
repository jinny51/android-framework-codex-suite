...
from android_framework_ops.remote_patch_snapshot import (  # noqa: E402
...
CAPTURE = SKILL_ROOT / "scripts" / "capture_framework_patch.py"
HANDOFF = SKILL_ROOT / "scripts" / "capture_remote_snapshot.py"
SNAPSHOT_MODULE = LIB_ROOT / "android_framework_ops" / "remote_patch_snapshot.py"
