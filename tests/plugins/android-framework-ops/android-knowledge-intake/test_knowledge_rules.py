...
class KnowledgeRulesTest(unittest.TestCase):
    ...
    def test_source_version_contract_uses_capability_matrix_not_current_version(self) -> None:
        ...
        self.assertEqual(current, "1.0.155")
        self.assertEqual(AKBS_RULES_CONTRACT_VERSION, "2026-08-24.1")
        ...
        self.assertEqual(matrix["weekly_effective_report_facts_v1"]["min_plugin_version"], "1.0.132")
        self.assertEqual(matrix["weekly_requirement_taxonomy_v1"]["min_plugin_version"], "1.0.133")
        self.assertEqual(matrix["weekly_work_type_v1"]["min_plugin_version"], "1.0.150")
        self.assertEqual(matrix["daily_work_type_v1"]["min_plugin_version"], "1.0.151")
        self.assertEqual(matrix["daily_work_type_inference_v1"]["min_plugin_version"], "1.0.152")
        self.assertEqual(matrix["report_document_work_v1"]["min_plugin_version"], "1.0.153")
        self.assertEqual(matrix["daily_no_focus_marker_v1"]["min_plugin_version"], "1.0.154")
        self.assertEqual(matrix["weekly_project_ledger_v2"]["min_plugin_version"], "1.0.155")
        ...
        self.assertEqual(matrix["verification_acceptance_v2"]["min_plugin_version"], "1.0.142")
