...
def adapter_environment(
    ...
    environment.setdefault(
        "ANDROID_REMOTE_CHANNEL_SCRIPT",
        str(plugin_root / "skills/android-remote-channel/scripts/remote-channel.sh"),
    )
    environment.setdefault(
        "ANDROID_REMOTE_SOURCE_INSPECTION_HELPER",
        str(plugin_root / "lib/android_framework_ops/remote_source_inspection.py"),
    )
