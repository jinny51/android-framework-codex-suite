...
| 知识系统 | [android-weekly-report-intake](https://github.com/jinny51/android-framework-codex-suite/tree/main/docs/skills/android-framework-ops/android-weekly-report-intake) | 汇总当前有效日报、上一周项目台账和文档进展，生成个人周报、同源 `report_view.json` 和 `weekly_trace` incoming |
