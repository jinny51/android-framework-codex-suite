...
| 知识系统 | [android-daily-report-intake](https://github.com/jinny51/android-framework-codex-suite/tree/main/docs/skills/android-framework-ops/android-daily-report-intake) | 按 Patch/App/GMS/Doc/Other 范围生成个人日报正文、同源 `report_view.json` 和 `daily_trace` incoming |
