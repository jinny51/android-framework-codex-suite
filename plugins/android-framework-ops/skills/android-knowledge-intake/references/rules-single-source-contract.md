...
These rules stay in database repository, intake branch, curation runner, UI API, or maintainer-side skills:
...
Phase 1-2 only proves generation into a temporary directory. Replacing database repository and intake branch copies is a later curation-runner task.
