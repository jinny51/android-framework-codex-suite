...
Use this reference as the Framework-domain operating protocol. It defines requirement specification, diagnosis, code-change discipline, risk judgment, final acceptance verification, and final reporting for that domain.

## Composable Use Contract

When user-provided skills, project-local rules, or review workflows exist, preserve them. Apply this reference only to the Android Framework domain's source access, diagnosis, build/deploy coordination, verification, patch capture, and knowledge reuse.
