...
- [scripts/Inspect-AndroidSdk.ps1](scripts/Inspect-AndroidSdk.ps1)：Android SDK 检查脚本。
- [scripts/Manage-AndroidSmbWindowsInfo.ps1](scripts/Manage-AndroidSmbWindowsInfo.ps1)：Windows SMB 映射信息管理脚本。
