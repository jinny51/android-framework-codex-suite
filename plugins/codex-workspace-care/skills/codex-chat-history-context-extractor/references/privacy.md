...
- Do not commit `auth.json`, `config.toml`, SQLite databases, `.jsonl` chat records, extracted context files, generated images, screenshots, shell snapshots, or backups.
