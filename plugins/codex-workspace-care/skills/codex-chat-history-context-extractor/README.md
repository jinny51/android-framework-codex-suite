...
- [references/privacy.md](references/privacy.md)：隐私处理规则。
- [scripts/extract_codex_context.py](scripts/extract_codex_context.py)：上下文（历史信息）提取脚本。
- [scripts/self_test_extract_codex_context.py](scripts/self_test_extract_codex_context.py)：自测脚本。
