...
from akbs_member_ops.knowledge_rules import find_company_project, find_company_projects
...
def discover_patches(
    ...
    *,
    ...
    if sessions:
        out_dir = expanded_path(config.get("out_dir", "$CODEX_HOME/artifacts/akbs-member-ops"))
