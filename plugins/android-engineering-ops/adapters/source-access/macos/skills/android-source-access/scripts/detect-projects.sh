...
Required integration:
  --channel-script PATH     android-remote-channel.sh from android-engineering-ops.
  --inspection-helper PATH  remote_source_inspection.py from android-engineering-ops.
