...
ARTIFACT_GUARD=(python3 -m android_engineering_ops.artifact_paths)
OWNER_TOKEN=""
DIAGNOSTICS_COMMITTED=0
MANAGED_OUTPUT=0
OUTPUT_HELPER=""
AKBS_AUTHORITY_ROOT=""
TASK_ID="android-change-workflow"
RUN_ID=""
...
python3 -m android_engineering_ops.install_family --plugin-root "$PLUGIN_ROOT"
